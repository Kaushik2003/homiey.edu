...
export default function CourseCreator() {
  ...
  const [contentArray, setContentArray] = useState<string[]>([]); // Explicitly define string[] type
  ...
  const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    setContentArray((prevArray) => [...prevArray, value]);
  };
  ...
  const generateWithAI = () => {
    ...
    setNewContent(
      "This content was generated with AI assistance. You can now edit it or keep it as is."
    );
  };
      ...
      <div className="space-y-6">
        ...
        {showNewBlock ? (
          <div className="bg-zinc-800 rounded-lg shadow-lg p-6 border border-zinc-700">
            ...
            <div className="flex justify-between">
              <div className="space-x-2">
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setShowEmbedToolbar(!showEmbedToolbar)}
                >
            ...
            {showEmbedToolbar && (
              <EmbedToolbar onEmbed={(type, data) => addModule(type, data)} />
            )}
          </div>
        ) : modules.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-zinc-400">
            ...
            <p className="text-zinc-500 mb-6">
              Modules you add will appear here
            </p>
